...
namespace Bannerlord.ButterLib.DelayedSubModule
{
    ...
    /// </remarks>
    public class DelayedSubModuleGlobalEventArgs : EventArgs
    {
        ...
        /// is not a valid <see cref="DelayedSubModuleGlobalEventArgs"/> enum.</exception>
        public DelayedSubModuleGlobalEventArgs(Type type, bool isBase, DelayedSubModuleSubscriptionType subscriptionType, string methodName)
        {

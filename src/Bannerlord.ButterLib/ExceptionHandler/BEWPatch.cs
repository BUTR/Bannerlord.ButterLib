...
namespace Bannerlord.ButterLib.ExceptionHandler
{
    ...
    internal sealed class BEWPatch
    {
        ...
        private static readonly string[] BEW = new[] { "org.calradia.admiralnelson.betterexceptionwindow" };
        ...
        private static readonly MethodInfo? MBSubModuleBaseOnSubModuleLoadMethod = AccessTools2.Method("TaleWorlds.MountAndBlade.MBSubModuleBase:OnSubModuleLoad");
        ...
        internal static void Enable(Harmony harmony)
        {
            ...
            if (!_wasButrLoaderInterceptorCalled)
                harmony.Patch(MBSubModuleBaseOnSubModuleLoadMethod, finalizer: new HarmonyMethod(FinalizerMethod, before: bew));
        ...
        internal static void Disable(Harmony harmony)
        {
            ...
            if (!_wasButrLoaderInterceptorCalled)
                harmony.Unpatch(MBSubModuleBaseOnSubModuleLoadMethod, FinalizerMethod);
        }

using Bannerlord.ButterLib.PublicHelpers;

using TaleWorlds.CampaignSystem;

namespace Bannerlord.ButterLib.PublicExtensions
{
    public static class MbEventExtensions
    {
        ...
        internal static class MbEvent5InvokeHandler<T1, T2, T3, T4, T5>
        {
            ...
            internal static readonly InvokeDelegate? deInvoke = AccessHelper.GetDelegate<InvokeDelegate>(typeof(MbEvent<T1, T2, T3, T4, T5>), "Invoke");
        }
        internal static class MbEvent6InvokeHandler<T1, T2, T3, T4, T5, T6>
        {
            ...
            internal static readonly InvokeDelegate? deInvoke = AccessHelper.GetDelegate<InvokeDelegate>(typeof(MbEvent<T1, T2, T3, T4, T5, T6>), "Invoke");
        }
